...
const faqDatabase = {
    entrepreneur: {
        keywords: ['创业', '商业', '商机', '机会', '风险', '市场', '创新', '执行力', '商业思维', '创业思维', '商业模式', '商机识别', '风险投资', '创业者', '创业精神', '创业能力', '创业技巧', '创业建议', '创业指导', '创业知识', '创业经验', '创业资源', '创业项目', '创业方向', '创业方法', '创业策略', '创业计划', '创业资金', '创业团队', '创业融资', '创业路演', '创业孵化', '创业加速器', '创业导师', '创业课程', '创业培训', '创业社群', '创业活动', '创业比赛', '创业大赛', '创业奖励', '创业补贴', '创业政策'],
        questions: [
            {
                question: '什么是创业思维？',
                keywords: ['创业思维', '创业', '思维'],
    ...
    love: {
        keywords: ['爱情', '恋爱', '感情', '关系', '亲密关系', '婚姻', '伴侣', '沟通', '冲突', '安全感', '共情', '情绪', '边界', '信任', '恋爱技巧', '恋爱建议', '感情问题', '分手', '复合', '表白', '约会', '求婚', '婚姻经营', '夫妻关系', '家庭关系', '亲子关系', '心理健康', '心理咨询', '心理辅导', '情商', '情绪管理', '压力管理', '焦虑', '抑郁', '自我成长', '自我认知', '人际关系', '社交技巧', '沟通技巧'],
        questions: [
            {
                question: '什么是健康的亲密关系？',
